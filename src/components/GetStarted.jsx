        ...
        <div className="relative z-10 flex flex-col md:flex-row items-center gap-12">
          ...
          <div className="flex-1 gs-content">
            <h2 className="font-heading font-black text-4xl md:text-5xl text-white mb-6 uppercase">
              Dominando o <br/>
              <span className="text-[#D00000] font-drama italic text-5xl md:text-6xl pt-2 inline-block">ABS, ESP e EPB.</span>
            </h2>
            <p className="text-[#ADB5BD] font-body text-lg mb-8 max-w-md">
              Aprenda a aplicar o método MDB e a rentabilizar de forma ágil e segura em sua oficina. Cadastre-se gratuitamente.
            </p>
            
            <ul className="flex flex-col gap-3 mb-10">
              {benefits.map((b, i) => (
                <li key={i} className="flex items-start gap-3">
                  <CheckCircle2 color="#D00000" size={20} className="shrink-0 mt-0.5" />
                  <span className="text-[#ADB5BD] font-light">{b}</span>
                </li>
              ))}
            </ul>
          </div>
          ...
          <div className="w-full md:w-auto gs-content flex flex-col items-center gap-4 bg-[#111] p-8 rounded-[2rem] border border-[#222] text-center">
            ...
            <h3 className="font-heading font-bold text-2xl text-white mt-4 text-center">100% ONLINE E GRATUITO</h3>
            <p className="text-[#ADB5BD] text-sm mb-6 max-w-[200px] text-center">Garanta sua vaga agora mesmo.</p>
            ...
            >
              <span className="relative z-10 w-full text-center whitespace-nowrap text-xs md:text-sm">Quero Participar do Evento Gratuito</span>
